...
-(void)setModel:(AddressModel *)model
{
    ...
    address.text = [NSString stringWithFormat:@"收货地址：%@ %@ %@ %@",GetSaveString(model.province),GetSaveString(model.city),GetSaveString(model.area),GetSaveString(model.fullAddress)];
}
