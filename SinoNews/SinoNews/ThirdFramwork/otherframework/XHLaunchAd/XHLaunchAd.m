...
-(void)addSkipButtonForConfiguration:(XHLaunchAdConfiguration *)configuration{
    ...
    if(configuration.customSkipView){
        ...
        //自定义跳过按钮的方位
        _skipButton.frame = CGRectMake(_skipButton.frame.origin.x, configuration.frame.size.height - _skipButton.frame.size.height - 10, _skipButton.frame.size.width, _skipButton.frame.size.height);
