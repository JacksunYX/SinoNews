...
- (void)createToolBarScroll {
    ...
    self.toolBarScroll = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, [self isIpad] ? self.view.frame.size.width : self.view.frame.size.width , kToolBarHeight)];
...
- (void)createParentHoldingView {
    ...
    //Background Toolbar
    UIToolbar *backgroundToolbar = [[UIToolbar alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, kToolBarHeight)];
    ...
    if (_alwaysShowToolbar) {
        self.toolbarHolder.frame = CGRectMake(0, self.view.frame.size.height - kToolBarHeight, self.view.frame.size.width, kToolBarHeight);
    } else {
        self.toolbarHolder.frame = CGRectMake(0, self.view.frame.size.height, self.view.frame.size.width, kToolBarHeight);
    }
...
//            toolbarWidth += buttonItem.customView.frame.size.width + 11.0f;
    ...
    self.toolbar.frame = CGRectMake(0, 0, toolbarWidth, kToolBarHeight);
    self.toolBarScroll.contentSize = CGSizeMake(self.toolbar.frame.size.width, kToolBarHeight);
}
