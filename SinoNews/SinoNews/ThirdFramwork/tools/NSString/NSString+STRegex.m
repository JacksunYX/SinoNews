...
+ (BOOL)isValidPhone:(NSString *)phone {
    ...
    /**
     ...
     11         * 134[0-8],135,136,137,138,139,147,150,151,157,152,157,158,159,178,182,187,188
     12         */
    NSString *chinaMobile = @"(^1(3[5-9]|4[7]|5[012789]|7[8]|8[23478]|9[8])\\d{8}$)|(^1(34[0-8]|70[356])\\d{7}$)";
    /**
     15         * 中国联通：China Unicom
     16         * 130,131,132,145,152,155,156,166,171,175,176,185,186
     17         */
    NSString * chinaUnicom = @"(^1(3[0-2]|4[5]|5[56]|6[6]|7[156]|8[56])\\d{8}$)|(^170[4789]\\d{7}$)";
    /**
     20         * 中国电信：China Telecom
     21         * 133,149,1349,153,180,181,189,199,1700,1701,1702
     22         */
    NSString * chinaTelecom = @"(^1(33|53|7[37]|8[019]|99)\\d{8}$)|(^170[012]\\d{7}$)";
