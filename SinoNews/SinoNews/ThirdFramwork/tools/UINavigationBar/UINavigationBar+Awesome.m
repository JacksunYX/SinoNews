...
//            GGLog(@"class:%@",NSStringFromClass([subView class]));
//            if ([subView isKindOfClass:NSClassFromString(@"_UIBarBackground")]||[subView isKindOfClass:NSClassFromString(@"_UINavigationBarBackground")]) {
//                subView.hidden = YES;
//
//            }
//        }
